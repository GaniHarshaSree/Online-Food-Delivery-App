    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult CustomerRegister(Customer customer)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("CustomerLogin", "Home"); // Assuming you have a Login action in HomeController
            }
        ...
        public ActionResult AdminLogin(string adminUsername, string adminPassword)
        {
            ...
            else
            {
                ...
                ModelState.AddModelError("", "Pleasew enetr valid Username and Password");
                return View();
            }
        }
