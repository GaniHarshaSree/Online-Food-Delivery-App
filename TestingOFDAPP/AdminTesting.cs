...
namespace TestingOFDAPP
{
    ...
    public class AdminTesting
    {
        ...
        {
            // Arrange
            string ausername1 = "Admin1"; 
            string apassword1 = "Admin1@123"; 
        ...
        public void TestingAdminWithInvalidCredentials()
        {
            ...
            // Assert
            //ClassicAssert.IsNotNull(username);
            ClassicAssert.AreNotEqual(username, admin.AdminUsername);
            //ClassicAssert.IsNotNull(password);
            ...
            // Assert
            //ClassicAssert.IsNotNull(username);
            ClassicAssert.AreNotEqual(username2, admin.AdminUsername);
            //ClassicAssert.IsNotNull(password);
            ClassicAssert.AreNotEqual(password2, admin.AdminPassword);
        }
